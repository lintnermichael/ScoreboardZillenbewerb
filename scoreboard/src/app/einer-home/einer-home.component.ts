...
@Component({
  selector: 'app-einer-home',
  standalone: true,
  imports: [MatListModule, MatDividerModule, CommonModule, FormsModule],
  templateUrl: './einer-home.component.html',
  styleUrl: './einer-home.component.css'
})
export class EinerHomeComponent {
  ...
  loadData(){
    this.apiService.getAllEinerHome().subscribe(data => {
      this.einer = data;
      console.log(data);
    });
  }
