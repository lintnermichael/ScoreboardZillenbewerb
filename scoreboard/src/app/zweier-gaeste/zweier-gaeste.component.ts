...
@Component({
  selector: 'app-zweier-gaeste',
  standalone: true,
  imports: [MatListModule, MatDividerModule, CommonModule, FormsModule],
  templateUrl: './zweier-gaeste.component.html',
  styleUrl: './zweier-gaeste.component.css'
})
export class ZweierGaesteComponent {
  ...
  loadData(){
    this.apiService.getAllZweierGuests().subscribe(data => {
      this.zweier = data;
      console.log(data);
    });
  }
